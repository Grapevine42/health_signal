            ...
            <SafeAreaView style={{flex: 1}}>
                <ScrollView>
                    ...
                    <Animated.Image
                        ...
                        source={require('../assets/images/deep/rectOver1.png')}
                    />

                    <Animated.Image
                        style={this._getStyle(2)}
                        source={require('../assets/images/deep/rectImg1.png')}
                    />
                    ...
                    <View style={styles.rectangle}>
                        ...
                        <Text style={styles.hashTag}>#술이술술, #맥주즐기는{'\n'}
                            #사람들과 어울리기 좋아하는</Text>
                    </View>
                    ...
                    <View style={{marginTop: 30}}>
                        ...
                        <View style={{
                            ...
                            <Text style={styles.mainTxt}>Glass</Text>
                            <Text style={styles.boldTxt}>98.5%</Text>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Text style={styles.mainTxt}>Alcohol</Text>
                            <Text style={styles.boldTxt}>97.6%</Text>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Text style={styles.mainTxt}>Drink</Text>
                            <Text style={styles.boldTxt}>97.6%</Text>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Text style={styles.mainTxt}>Beer</Text>
                            <Text style={styles.boldTxt}>97.6%</Text>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Text style={styles.mainTxt}>Beverage</Text>
                            <Text style={styles.boldTxt}>97.6%</Text>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Text style={styles.mainTxt}>Beer Glass</Text>
                            <Text style={styles.boldTxt}>97.3%</Text>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Text style={styles.boldTxt}>93.3%</Text>
                        </View>
